...
export const PRODUCTS: Product[] = [
  {
    ...
    benefits: [
      { icon: "⚡", title: "Joint Mobility",  desc: "Restores flexibility and comfort in ageing joints" },
      { icon: "❤️", title: "Daily Vitality",  desc: "Sustained energy and overall wellness all day" },
      { icon: "🌿", title: "12 Indian Herbs", desc: "Classical Ayurvedic anti-inflammatory complex" },
      { icon: "✨", title: "Coat & Skin",     desc: "Lustrous coat visible within 4–6 weeks" },
    ],
  ...
  },
  {
    ...
    benefits: [
      { icon: "✨", title: "Mirror-Bright Coat", desc: "Visible sheen improvement in 2–3 weeks" },
      { icon: "💧", title: "Deep Hydration",     desc: "Resolves dry, flaky, and itchy skin" },
      { icon: "🍃", title: "Neem & Bhringraj",  desc: "Classical Ayurvedic botanical duo" },
      { icon: "🛡️", title: "Barrier Repair",   desc: "Strengthens the skin's natural microbiome" },
    ],
  ...
  },
  {
    ...
    benefits: [
      { icon: "🛡️", title: "Immune Defence",   desc: "Tulsi, Giloy & Amla triple-action complex" },
      { icon: "🌱", title: "Gut Microbiome",   desc: "10-strain clinically-studied probiotic blend" },
      { icon: "🍊", title: "Natural Vitamin C", desc: "Amla — the world's richest natural source" },
      { icon: "⚡", title: "Fast Absorption",  desc: "Soxhlet liquid extraction for bioavailability" },
    ],
  ...
  },
  {
    ...
    benefits: [
      { icon: "🌙", title: "Calms Anxiety",     desc: "Non-sedative, natural calming without drowsiness" },
      { icon: "😴", title: "Better Sleep",       desc: "Valerian & Brahmi deep-sleep complex" },
      { icon: "🧠", title: "Cognitive Support", desc: "Brahmi enhances mental clarity and focus" },
      { icon: "✈️", title: "Travel & Stress",   desc: "Safe for daily and situational use" },
    ],
